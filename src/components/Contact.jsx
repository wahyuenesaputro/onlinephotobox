...
const Contact = () => {
  return (
    <div id="contact" className="w-full py-20 bg-gradient-to-b from-white to-pink-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <a key={idx} href="#" className="flex flex-col items-center group p-4 rounded-xl hover:bg-white hover:shadow-md transition-all">
                <div className="w-16 h-16 bg-gradient-to-br from-pink-400 to-pink-600 rounded-full flex items-center justify-center text-white mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  {item.icon}
                </div>
